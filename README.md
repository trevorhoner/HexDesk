...
![HexDesk computer desk](/images/mounting-interface.PNG)

![HexDesk computer desk](/images/mounting-clamp.png)
...
HexDesk utilizes a hole-pin mating pattern with a standardized hole spacing of 25mm. Users can build nearly infinite desk setups e.g. shelves, monitor arms, cupholders, cord organizers, and much more. The idea was to create a system that would be easy to use, somewhat stylish, and difficult to master.
